...
import static org.radarcns.domain.restapi.header.MonitorHeader.MONITOR_CATEGORY.QUESTIONNAIRE;
...
import org.radarcns.domain.restapi.QuestionnaireCompletionData;
...
public class QuestionnaireCompletionLogWrapper {
     ...
     */
    public QuestionnaireCompletionData valueByProjectSubjectSource(String project, String subject, String source,
            MongoClient client) {
