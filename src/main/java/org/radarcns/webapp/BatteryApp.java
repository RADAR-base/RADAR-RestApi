...
public class BatteryApp {
    ...
    public Response getRealTimeUser(
        ...
        try {
            ...
            Dataset battery = BatteryDAO.getInstance().valueRTByUserSource(userID, sourceID, stat, context);
    ...
    public Response getAllByUser(
        ...
        try {
            ...
            Dataset battery = BatteryDAO.getInstance().valueByUserSource(userID, sourceID, stat, context);
    ...
    public Response getByUserForWindow(
        ...
        try {
            ...
            Dataset battery = BatteryDAO.getInstance().valueByUserSourceWindow(userID, sourceID, stat, start, end, context);
