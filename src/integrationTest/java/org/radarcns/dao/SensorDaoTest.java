...
//
//        dirtyCollections.add(DataSetService.getInstance(SENSOR_TYPE).getCollectionName(
//                SOURCE_TYPE, TIME_WINDOW));
//
...
//        long end = docs.get(index + 1).getDate(END).getTime();
//
//        double actual = DataSetService.getInstance(
...
//
//        MongoCollection<Document> collection = MongoHelper.getCollection(client,
//                DataSetService.getInstance("HEART_RATE").getCollectionName(
//                SOURCE_TYPE, TIME_WINDOW));
//
//        dirtyCollections.add(DataSetService.getInstance("HEART_RATE").getCollectionName(
//                SOURCE_TYPE, TIME_WINDOW));
//
...
//            DataSetService.getInstance("ACCELEROMETER").getCollectionName(SOURCE_TYPE,
//                TIME_WINDOW));
//
//        dirtyCollections.add(DataSetService.getInstance("ACCELEROMETER").getCollectionName(
//                SOURCE_TYPE, TIME_WINDOW));
//
...
//                randomInput);
//
//        EffectiveTimeFrame actual = DataSetService.getInstance()
