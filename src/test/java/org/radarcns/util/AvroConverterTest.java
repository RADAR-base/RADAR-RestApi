...
//
//        LinkedList<DataItem> item = new LinkedList<>();
//        item.add(new DataItem(new Double(1.0), RadarConverter.getISO8601(new Date())));
//        item.add(new DataItem(new Double(2.0), RadarConverter.getISO8601(new Date())));
//        testCases.add(AvroConverter.avroToJsonNode(new Dataset(header, item)));
//
//        item = new LinkedList<>();
//        item.add(new DataItem(new Quartiles(1.0, 1.0, 1.0),
//                RadarConverter.getISO8601(new Date())));
//        item.add(new DataItem(new Quartiles(2.0, 2.0, 2.0),
//                RadarConverter.getISO8601(new Date())));
//        testCases.add(AvroConverter.avroToJsonNode(new Dataset(header, item)));
//
//        item = new LinkedList<>();
//        item.add(new DataItem(new Acceleration(1.0, 1.0, 1.0),
//                RadarConverter.getISO8601(new Date())));
//        item.add(new DataItem(new Acceleration(2.0, 2.0, 2.0),
//                RadarConverter.getISO8601(new Date())));
//        testCases.add(AvroConverter.avroToJsonNode(new Dataset(header, item)));
//
//        item = new LinkedList<>();
//        item.add(new DataItem(new Acceleration(new Quartiles(1.0, 1.0, 1.0),
//                new Quartiles(1.0, 1.0, 1.0),
//                new Quartiles(1.0, 1.0, 1.0)),
//                RadarConverter.getISO8601(new Date())));
//        item.add(new DataItem(new Acceleration(new Quartiles(2.0, 2.0, 2.0),
